            ...
            <div className="player-tabs container mt-5">
                <ul className="nav nav-tabs" role="tablist">
                    <li className="nav-item">
                        <a className="nav-link active" id="course-content-tab" data-toggle="tab" href="#course-content" role="tab" aria-controls="course-content" aria-selected="true">Course content</a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" id="qa-tab" data-toggle="tab" href="#qa" role="tab" aria-controls="qa" aria-selected="false">Q{'&'}A</a>
                    </li>
                    <li className="nav-item">
