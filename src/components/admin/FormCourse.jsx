...
class FormCourse extends Component {
    ...
    handleOnSubmit = (event) => {
        ...
        if (this.isEdit) {
            this.props.editCourse(this.state, fd);
        }
        else {
            this.props.addCourse(this.state, fd)
        }
    ...
    componentWillReceiveProps = (nextProp) => {
        this.setState(nextProp.courseDetail);
    }
        ...
        return (
            <div className="container">
                <form id="form" onSubmit={this.handleOnSubmit} >
                    ...
                    <fieldset>
                        <input placeholder="Admin account" type="text" name="taiKhoanNguoiTao" value={this.state.taiKhoanNguoiTao} tabIndex={7} required onChange={this.handleOnchange} />
                    </fieldset>
                    <fieldset>
...
const mapStateToProps = (state) => {
    console.log("TCL: mapStateToProps -> state.CourseReducerStore.courseDetail", state.CourseReducerStore)
    return {
